...
// Global Variables -----------------------------------------------------------------------------------
int joystick_x = 0, joystick_y = 0; //Values to be read in from the joystick
...
int signalFilter(int joystickValue, int filterCase)
{
  ...
  {
    case 0: //Joystick x
      if(abs(neutral_x-joystickValue) > 10)
      ...
      break;
    case 1: //Joystick y
      if(abs(neutral_y-joystickValue) > 10)
